...
export class FuncionService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/funcions';
  ...
  update(funcion: IFuncion): Observable<EntityResponseType> {
    return this.http.put<IFuncion>(this.resourceUrl, funcion, { observe: 'response' });
  }
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IFuncion[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
