...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Persona}.
 */
@RestController
@RequestMapping("/api")
public class PersonaResource {
    ...
    public PersonaResource(PersonaRepository personaRepository, PersonaSearchRepository personaSearchRepository) {
