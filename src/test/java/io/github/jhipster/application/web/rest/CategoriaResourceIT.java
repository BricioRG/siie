...
public class CategoriaResourceIT {
    ...
    private static final String DEFAULT_TIPOCAT = "AAAAAAAAAA";
    private static final String UPDATED_TIPOCAT = "BBBBBBBBBB";
     ...
     *
     * @see io.github.jhipster.application.repository.search.CategoriaSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final CategoriaResource categoriaResource = new CategoriaResource(categoriaRepository, mockCategoriaSearchRepository);
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getTipocat()).isEqualTo(DEFAULT_TIPOCAT);
        assertThat(testCategoria.getClave()).isEqualTo(DEFAULT_CLAVE);
    ...
    public void getAllCategorias() throws Exception {
        ...
        restCategoriaMockMvc.perform(get("/api/categorias?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tipocat").value(hasItem(DEFAULT_TIPOCAT.toString())))
    ...
    public void getCategoria() throws Exception {
        ...
        restCategoriaMockMvc.perform(get("/api/categorias/{id}", categoria.getId()))
            ...
            .andExpect(jsonPath("$.tipocat").value(DEFAULT_TIPOCAT.toString()))
    ...
    public void updateCategoria() throws Exception {
        ...
        Categoria testCategoria = categoriaList.get(categoriaList.size() - 1);
        assertThat(testCategoria.getTipocat()).isEqualTo(UPDATED_TIPOCAT);
        assertThat(testCategoria.getClave()).isEqualTo(UPDATED_CLAVE);
    ...
    public void searchCategoria() throws Exception {
        ...
        restCategoriaMockMvc.perform(get("/api/_search/categorias?query=id:" + categoria.getId()))
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(categoria.getId().intValue())))
            .andExpect(jsonPath("$.[*].tipocat").value(hasItem(DEFAULT_TIPOCAT)))
