...
public class SiieKafkaResourceIT {
    ...
    @BeforeEach
    public void setup() {
        SiieKafkaResource kafkaResource = new SiieKafkaResource(kafkaProducer);
    ...
    public void sendMessageToKafkaTopic() throws Exception {
        restMockMvc.perform(post("/api/siie-kafka/publish?message=yolo"))
