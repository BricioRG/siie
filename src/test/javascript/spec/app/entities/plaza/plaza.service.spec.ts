...
describe('Service Tests', () => {
  describe('Plaza Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(PlazaService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Plaza(0, 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Plaza', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaini: currentDate.format(DATE_FORMAT),
      ...
      it('should update a Plaza', async () => {
        const returnedFromService = Object.assign(
          {
            horas: 'BBBBBB',
            fechaini: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of Plaza', async () => {
        const returnedFromService = Object.assign(
          {
            horas: 'BBBBBB',
            fechaini: currentDate.format(DATE_FORMAT),
